      ...
      <Lesson10Container>
        ...
        <SectionWrapper>
          ...
          <NoteBlock>
            ...
            <NoteDescription>
            Даже несколько слов вроде "Привет", "Спасибо" и "Сколько это стоит?" помогут наладить контакт с местными жителями
             и проявить уважение к их культуре
            </NoteDescription>
          </NoteBlock>
          <NoteBlock>
            <NoteTitle>Будьте открыты к новому опыту.</NoteTitle>
            <NoteDescription>
